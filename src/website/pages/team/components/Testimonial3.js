      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="w-50">
            ...
            >
              <SwiperSlide>
                <div className="d-shadow bgwhite rounded-10 testimonial-h prpx20 plpx20 ptpx20 pbpx20">
                  ...
                  <div className="flex items-center gap-4 mtpx20">
                    <img
                      ...
                      alt="testimonial-img"
                      className="testimonial-img object-contain"
                    />
                    <div className="mlpx10">
                      <h4 className="fsize20  text-center md-fsize23 sm-fsize18 mtpx1 mbpx1 textdark">
