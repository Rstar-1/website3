...
const HeroSection3 = () => {
  return (
    <div className="relative herosection3-img bgforth">
      <img
        src="https://zyan.vercel.app/images/bg/banner.jpg"
        alt="herosection3-img"
        className="w-full sm-hidden herosection3-img object-cover"
      />
      <div className="absolute sm-relative top-0 text-left left-0 flex items-center herosection3-img">
        <div className="w-full container mx-auto">
          <div className="flex sm-block items-center sm-ptpx30 sm-pbpx40">
            <div className="w-50 sm-w-full">
              ...
              <div className="flex items-center justify-start gap-10 mtpx30 md-mtpx20 sm-mtpx20">
                ...
                <div className="mlpx15 sm-mlpx8 flex items-center">
                  <div className="video3-icon flex items-center justify-center">
                    <FeatherIcon
                      icon="play"
                      fill="#000"
                      size="20"
                  ...
                  <p className="mlpx10 sm-mlpx8 fsize16 sm-fsize13 textwhite">Watch The Video</p>
                </div>
              </div>
            </div>
            <div className="w-50 sm-mtpx50 sm-w-full">
              <div className="relative w-full">
                <img
                  src="https://zyan.vercel.app/images/banner_img_1.png"
                  alt="herosecondsection3-img"
                  className="w-full herosecondsection3-img object-contain"
                />
                <img
                  src="https://zyan.vercel.app/images/shapes/banner_shape.png"
                  alt="herothirdsection3-img"
                  className="w-full herothirdsection3-img absolute center-absolute object-contain"
                />
              </div>
            </div>
          </div>
