    ...
    <div className="ptpx60 pbpx60 md-ptpx20 md-pbpx20 sm-ptpx20 sm-pbpx20">
      <div className="container mx-auto">
        <div className="flex sm-flex-column-reverse w-full items-center">
          <div className="w-50 sm-w-full prpx20 md-prpx9 sm-prpx1 sm-mtpx20">
            ...
            <div className="grid-cols-2 sm-grid-cols-1 mtpx25 sm-mtpx14 bordb bordh pbpx20 ptpx20">
              <div className="flex items-center prpx8">
                <img
                  ...
                  alt="rightsecondabout9-img"
                  className="rightsecondabout9-img object-contain"
                />
                <div className="mlpx8">
          ...
          <div className="w-50 sm-w-full plpx20 md-plpx1 sm-plpx1 ">
            <img
              ...
              className="w-full rightabout9-img object-contain"
              alt="rightabout9-img"
            />
          </div>
        </div>
...
export default RightImageSection9;
