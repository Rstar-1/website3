...
const RightImageSection4 = () => {
  return (
    <div className="ptpx60 pbpx90 md-ptpx30 md-pbpx60 bg-fa sm-ptpx20 sm-pbpx20">
      <div className="container mx-auto">
        <div className="flex sm-flex-column-reverse w-full items-center">
          <div className="w-50 sm-w-full sm-mtpx50 prpx20 md-prpx9 sm-prpx1">
          ...
          <div className="w-50 sm-w-full plpx20 md-plpx1 sm-plpx1">
            <div className="relative">
              <img
                ...
                className="w-70 md-w-80 sm-w-80 rightabout4-img object-cover rounded-10"
                alt="rightabout4-img"
              />
              <div className="absolute bottom-0 right-0 w-70">
                <img
                  ...
                  className="w-full rightsecondabout4-img object-cover rounded-10"
                  alt="rightsecondabout4-img"
                />
              </div>
...
export default RightImageSection4;
