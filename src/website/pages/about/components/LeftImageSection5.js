          ...
          <div className="w-50 sm-w-full prpx20 md-prpx9 sm-prpx1">
            <div className="relative">
              <img
                ...
                className="w-full leftabout5-img object-contain rounded-10"
                alt="leftabout5-img"
              />
              <div className="center-absolute w-70 md-w-90 sm-w-90 absolute z-30">
                <img
                  ...
                  className="w-full leftsecondabout5-img object-cover rounded-10"
                  alt="leftsecondabout5-img"
                />
                <div className="absolute bottom-0 left-0 flex justify-center">
                  <div className="bgwhite p10 cardabout-bottom w-80 sm-w-90 flex items-center">
                    <img
                      ...
                      className="leftthirdabout5-img object-contain rounded-10"
                      alt="leftthirdabout5-img"
                    />
                    <div className="mlpx8">
              ...
              <div className="absolute top-0 left-0 z-50">
                <div className="rounded-5 float-card p15">
                  <h5 className="fsize36 md-fsize24 sm-fsize18 textwhite mtpx1 mbpx1 font-600">12</h5>
                  <p className="fsize16 md-fsize14 sm-fsize13 textwhite">years of experiences</p>
                </div>
                <img
                  src="https://html.themexriver.com/it-firm/images/icons/about-dots.png"
                  alt="leftforthabout5-img"
                  className="leftforthabout5-img absolute top-0 right-0 m9"
                />
              </div>
              <div className="absolute bottom-0 right-0 z-10">
                <img
                  src="https://html.themexriver.com/it-firm/images/background/pattern-13.png"
                  alt="leftsixthabout5-img"
                  className="leftsixthabout5-img"
                />
              </div>
            </div>
          </div>
          <div className="w-50 sm-w-full plpx20 md-plpx9 sm-plpx1 sm-mtpx30">
            <div className="flex items-center">
              ...
              <img
                ...
                alt="leftfifthabout5-img"
                className="leftfifthabout5-img mlpx5 mbpx2 object-contain"
              />
            </div>
...
export default LeftImageSection5;
