      ...
      <div className="container mx-auto">
        <div className="flex sm-block w-full items-center">
          <div className="w-40 md-w-50 sm-w-full">
            <div className="bgprimary leftabout2-img w-80 rounded-10">
              <img
                src="https://html.themexriver.com/it-firm/images/resource/about-2.jpg"
                className="w-full leftabout2-img about-margin rounded-10 object-cover"
                alt="leftabout2-img"
              />
            </div>
          </div>
...
export default LeftImageSection2;
